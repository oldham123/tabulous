app.directive('mdxPaintFg',function(mdx) {
    "use strict";
    return {
      restrict : 'A',
  ...
  app.directive('mdxPaintBg',function(mdx) {
    "use strict";
    return {
      restrict : 'A',
      link     : function(scope, element, attributes) {
  ...
  app.directive('mdxPaintSvg',function(mdx) {
      "use strict";
      return {
        restrict : 'A',
        link     : function(scope, element, attributes) {
  ...
  app.provider('mdx',function($mdThemingProvider){
    return {
      $get : function() {
        "use strict";
        return {
